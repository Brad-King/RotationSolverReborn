...
[Rotation("Basic DPS BLU", CombatType.PvE, GameVersion = "7.11")]
[SourceCode(Path = "main/BasicRotations/Limited Jobs/BLU_DPS.cs")]
[Api(4)]
public sealed class Blue_DPS : BlueMageRotation
{
    ...
    public bool UseBasicInstinct { get; set; } = false;

    [RotationConfig(CombatType.PvE, Name = "Use Mighty Guard")]
    public bool UseMightyGuard { get; set; } = false;
    ...
    public Blue_Basic()
    {
        ...
        BluDPSSpellActions.Add(BluDPSSpell.SharpenedKnife, GoblinPunchPvE);
        ...
        BluAOESpellActions.Add(BluAOESpell.Electrogenesis, ElectrogenesisPvE);
